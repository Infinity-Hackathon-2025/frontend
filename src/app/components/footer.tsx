              ...
              <div className="mt-4 flex items-center gap-4">
                ...
                <a href="#" aria-label="Instagram" className="transition hover:opacity-80">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                       className="stroke-white"><rect x="3" y="3" width="18" height="18" rx="5"
                       strokeWidth="1.6"/><circle cx="12" cy="12" r="4" strokeWidth="1.6"/><circle cx="17.5" cy="6.5" r="1.2" fill="white"/></svg>
                </a>
               
                <a href="#" aria-label="X" className="transition hover:opacity-80">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                       className="stroke-white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
