...
const Navbar = () => {
  ...
  return (
    <header className="w-full fixed top-0 left-0 z-50 flex items-center justify-between px-10 py-6">
      ...
      <nav className="absolute left-1/2 -translate-x-1/2 bg-white/20 backdrop-blur-md border border-white/30 shadow-lg rounded-full px-5 py-5 flex items-center justify-center">
